      ...
      <div>
        ...
        <section id="pantalla-inicial">
          <div id="instrucciones-texto" style = {{marginTop: '75.5px'}}>
            <input style = {{borderRadius: '7.5px', padding: '4.5px', fontSize: '19.5px', width: '64.5%'}} type="text" placeholder="Ingrese su nombre: " id="inputLabel" onChange={(text) => { setNombre(text.target.value) }}></input>



            <p style = {{marginTop: '24.5px', fontWeight: 'bold', fontSize: '19.5px'}}>Rol:</p>


<div style = {{width: '64.5%', marginLeft: 'auto', marginRight: 'auto'}}>
